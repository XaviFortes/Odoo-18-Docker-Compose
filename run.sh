...
git clone --depth=1 https://github.com/XaviFortes/Odoo-18-Docker-Compose $DESTINATION
...
echo "Odoo started at http://localhost:$PORT | Master Password: XF-Odoo-18-Docker-Compose* | Live chat port: $CHAT"